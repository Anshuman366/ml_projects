...
class Housing_exception(Exception):
    ...
    def __init__(self,error_message:Exception,error_details:sys):
        ...
        self.error_message=error_message #Housing_exception.get_detailed_error_message(error_message=error_message,error_details=error_details)
    ...
    def get_detailed_error_message(error_message:Exception,error_details:sys)->str: 
        ...
        line_no_of_error=traceback_of_error.tb_frame.f_lineno
        
        # this will give the file name of the error
        filename_of_error=traceback_of_error.tb_frame.f_code.co_filename
        
        error_message= f"Error occured in script: [{filename_of_error}] in line no: [{line_no_of_error}], error message is [{error_message}] "
