...
class ModelTrainer:
    ...
    def initiate_model_trainer(self):#->ModelTrainerArtifact
        try:
            #steps:
            # 1) get the training and testing file path and store it in the form of array 
            #step 2)  get the testing file path and store it in the form of array 
            #step 3) get the testing and training dataset
            # step 4) get the model.yaml file path whichis already returnd by the configuration.get_model_training_config
            # step 6) get the best accuracy
            
            
            # step 1) get the training  file path and store it in the form of array 
            ...
            #step 5) now we will have to create the object of ModelFactory class to utilize various function
            ...
            # step 7) we will get the best model by utilizing the get_best_model from Modelfactory class
